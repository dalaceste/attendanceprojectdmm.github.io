...
<head>
    ...
    <link href="img/logo/DMMMSU-Logo-Final-768x768.png" rel="icon">
    <title>Student Attendance - Forget Password</title>
                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    <div class="text-center">
                                        <img src="img/logo/DMMMSU-Logo-Final-768x768" style="width:100px;height:100px">
                                        <br><br>
